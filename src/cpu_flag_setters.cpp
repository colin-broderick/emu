 ...
 */
void Cpu6502::LDA_set_CPU_flags()
{
    N = (A & BIT7);
    Z = (A == 0);
}
 ...
 */
void Cpu6502::CMP_set_CPU_flags(const Byte data_from_memory)
{
 ...
 * The zero (Z) flag is set if the value of the accumulator is zero.
 */
void Cpu6502::EOR_set_CPU_flags()
{
    LDA_set_CPU_flags();
}
 ...
 */
void Cpu6502::DEC_set_CPU_flags(const Byte data_from_memory)
{
 ...
 * The zero (Z) flag is set if the value is equal to zero.
 */
void Cpu6502::INC_set_CPU_flags(const Byte data_from_memory)
{
 ...
 * The zero (Z) flag is set if the value of the accumulator is zero.
 */
void Cpu6502::ORA_set_CPU_flags()
{
    LDA_set_CPU_flags();
}
 ...
 */
void Cpu6502::LDX_set_CPU_flags()
{
    N = (X & BIT7);
    Z = (X == 0);
}
 ...
 */
void Cpu6502::LDY_set_CPU_flags()
{
    N = (Y & BIT7);
    Z = (Y == 0);
}
 ...
 * The zero (Z) flag is set if X is equal to zero.
 */
void Cpu6502::TAX_set_CPU_flags()
{
    LDX_set_CPU_flags();
}
 ...
 * The zero (Z) flag is set if the value of the accumulator is zero.
 */
void Cpu6502::TXA_set_CPU_flags()
{
    LDA_set_CPU_flags();
}
 ...
 * The zero (Z) flag is set if X is equal to zero.
 */
void Cpu6502::DEX_set_CPU_flags()
{
    LDX_set_CPU_flags();
}
 ...
 * The zero (Z) flag is set if X is equal to zero.
 */
void Cpu6502::INX_set_CPU_flags()
{
    LDX_set_CPU_flags();
}
 ...
 * The zero (Z) flag is set if Y is equal to zero.
 */
void Cpu6502::DEY_set_CPU_flags()
{
    LDY_set_CPU_flags();
}
 ...
 * The zero (Z) flag is set if Y is equal to zero.
 */
void Cpu6502::INY_set_CPU_flags()
{
    LDY_set_CPU_flags();
}
 ...
 */
void Cpu6502::CPX_set_CPU_flags(const int data)
{
    C = (data >= 0);
    Z = (data == 0);
    N = (data & BIT7);
 ...
 * The negative (N) flag is set if bit 7 of the value is equal to one; this is the sign bit if the value is interpreted as a signed.
 */
void Cpu6502::CPY_set_CPU_flags(const int data)
{
 ...
 * The zero (Z) flag is set if the value of the accumulator is zero.
 */
void Cpu6502::AND_set_CPU_flags()
{
    LDA_set_CPU_flags();
}
